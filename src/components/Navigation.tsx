        ...
        <Collapse isOpen={isOpen} navbar>
          <Nav navbar className={home === otherUrl ? "nav-default" : ""}>
            ...
            <div className={home === otherUrl ? "d-none" : "align-left"}>
              <NavbarBrand
                className={
                  home === otherUrl ? "" : "d-none d-md-flex div-brand-alt"
                }
                href="/"
              >
                <img
                  className="logo-img"
                  src={constants.COMPANY_LOGO}
            ...
            <div className={home === otherUrl ? "centered-nav" : "align-right"}>
              ...
              <NavbarBrand
                className={
                  home === otherUrl ? "div__brand d-none d-md-block" : "d-none"
                }
                href="/"
              >
                <img
              ...
              <div
                className={
                  home === otherUrl ? "btn__contact-home" : "btn__contact"
                }
              >
                <ContactUsModal />
              </div>
